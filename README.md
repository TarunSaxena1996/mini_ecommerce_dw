...
It demonstrates ELT (staging → transform → load), snowflake-schema modeling, and analytical queries suitable for dashboards and ML feature extraction.
...
- Transformation encapsulated in `transformed_sales` view 
